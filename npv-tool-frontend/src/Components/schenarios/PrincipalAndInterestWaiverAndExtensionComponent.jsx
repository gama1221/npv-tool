...
const PrincipalAndInterestWaiverAndExtensionComponent = ({ data }) => {
  ...
  const exportToPDF = () => {
    ...
    doc.text("NPV With Principal & Interest Waiver plus Extension Amortization Table", 20, 10)
    ...
    doc.save(`principal-interest-waiver-plus-extension-amortization-table ${date}.pdf`)
  };
...
export default PrincipalAndInterestWaiverAndExtensionComponent;