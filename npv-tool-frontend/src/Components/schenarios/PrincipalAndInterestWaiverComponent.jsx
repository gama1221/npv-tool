...
const PrincipalWaiverComponent = ({ data }) => {
  ...
  const exportToPDF = () => {
    ...
    doc.text("NPV With Principal and Interest Waiver Amortization Table", 20, 10)
    ...
    doc.save(`principal-and-interest-waiver-amortization-table ${date}.pdf`)
  };
...
export default PrincipalWaiverComponent;